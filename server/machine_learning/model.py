...
example_data = [
    {"user_query": "Top 3 best electricity resistance material", "mongo_query": "[{\"$unwind\": \"$parsed_properties.Electrical Properties.Electrical Resistivity\"},{\"$sort\": {\"parsed_properties.Electrical Properties.Electrical Resistivity.metric.max\": -1}},{\"$limit\": 3},{\"$project\": {\"Material Name\": 1,\"parsed_properties.Electrical Properties.Electrical Resistivity\": 1}}]"},
    {"user_query": "What are the strongest ceramic material", "mongo_query": "[{\"$match\": {Categories: {\"$all\": [\"Ceramic\"]}}},{\"$project\": {\"Material Name\": 1,\"Tensile Strength (Metric)\": { \"$max\": \"$parsed_properties.Mechanical Properties.Tensile Strength, Ultimate.metric.max\"},\"Tensile Strength (English)\": {\"$max\": \"$parsed_properties.Mechanical Properties.Tensile Strength, Ultimate.english.max\"}}},{\"$sort\": {\"Tensile Strength (Metric)\": -1,\"Tensile Strength (English)\": -1}}]"},
    {"user_query": "What are the material with the tensile strength bigger than 1235MPa", "mongo_query": "[{\"$match\": {\"parsed_properties.Mechanical Properties.Tensile Strength.metric.max\": { \"$gt\": 1235 }}}]"},
    {"user_query": "What are the Metal material with the tensile strength bigger than 179100 psi", "mongo_query": "[{\"$match\": {\"Categories\": \"Metal\",\"parsed_properties.Mechanical Properties.Tensile Strength, Yield.english.max\": { \"$gt\": 179100 }}},{\"$project\": {\"Material Name\": 1,\"parsed_properties.Mechanical Properties.Tensile Strength, Yield.english\": 1}}]"}
]
